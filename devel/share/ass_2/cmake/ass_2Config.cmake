...
if(ass_2_CONFIG_INCLUDED)
  return()
endif()
set(ass_2_CONFIG_INCLUDED TRUE)
...
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'ass_2' is deprecated")
...
if(NOT "/home/experimental_ws/devel/include;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${ass_2_DIR}/../../../include" ABSOLUTE)
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(ass_2_LIBRARY_DIRS ${lib_path})
      list(APPEND ass_2_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'ass_2'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND ass_2_LIBRARIES ${lib})
    endif()
  endif()
...
set(ass_2_EXPORTED_TARGETS "ass_2_generate_messages_cpp;ass_2_generate_messages_eus;ass_2_generate_messages_lisp;ass_2_generate_messages_nodejs;ass_2_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${ass_2_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 ass_2_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${ass_2_dep}_FOUND)
      find_package(${ass_2_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ass_2_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(ass_2_INCLUDE_DIRS ${${ass_2_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(ass_2_LIBRARIES ${ass_2_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${ass_2_dep}_LIBRARIES})
  _list_append_deduplicate(ass_2_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(ass_2_LIBRARIES ${ass_2_LIBRARIES})

  _list_append_unique(ass_2_LIBRARY_DIRS ${${ass_2_dep}_LIBRARY_DIRS})
  list(APPEND ass_2_EXPORTED_TARGETS ${${ass_2_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "ass_2-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${ass_2_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
